      ...
      <section class="mainlyContent">
        ...
        <div class="featured-content">
          <div class="row no-gutters">
            ...
            <?php
              query_posts('showposts=1&post_type=carros');
            ?>
                  ...
                  <div class="positionTextFeatured">
                    <h2>
                      <?php $category_detail=get_the_category();//$post->ID
                        if(array_key_exists('cat_name', $category_detail)){
                          echo "<label class='glyphicon glyphicon-stop' aria-hidden='true'></label>" . $category_detail->cat_name;
                        } else {
                          echo '';
                        }
                      ?>
                    </h2>
                    <h3><a href="#" id="mainFeatured-<?php echo get_the_ID() ?>">BMW confirma novos X1<br> e série 3 no Brasil</a></h3>
                  </div> 
                </div>
              </div>
            <?php endwhile; ?>
            ...
            <?php
              query_posts('showposts=1&post_type=carros&offset=1');
            ?>
            <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            ...
            <?php
              query_posts('showposts=2&post_type=carros&offset=2');
            ?>
            <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
              <div class="col-md-3 col-sm-6">
                <div class="mainFeatured-small">
        ...
        <div class="columnGroup">
          <div class="row no-gutters">
            <?php
              query_posts('showposts=4&post_type=carros&offset=4');
            ?>
            <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="columnModule">
                  ...
                  <p class="ColumnModuleLink"><a href="<?php the_permalink(); ?>">+ Troller T4X Jeep Renegade</a></p>
                </div>
              </div>
            <?php endwhile; ?>
            <?php endif; ?>
